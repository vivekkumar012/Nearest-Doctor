        ...
        <div className="flex items-center">
          ...
          <Link to={"/"}>
            <h2 className="font-bold text-2xl">
              Nearest <span className="text-blue-800">Doctor</span>
            </h2>
          </Link>
        </div>
        <div className="flex items-center">
          ...
          <Link
            to={"/chooser"}
            className="text-xl font-medium ml-5 bg-blue-600 text-white rounded-full px-4 py-2 hover:bg-blue-900 hover:text-white cursor-pointer"
          >
            Get Started
          </Link>
        </div>
